    ...
    describe("Circle", () => {
        describe("Render Method", () => {
            test("renders circle", () => {
                ...
                const renderString = `<circle cx="50" cy="50" r="40" fill="${testCircle.shapeColor}"/>`;
    ...
    describe("Square", () => {
        describe("Render Method", () => {
            test("renders square", () => {
                ...
                const renderString = `<rect x="50" y="20" width="150" height="150" fill="${testSquare.shapeColor}"/>`;
    ...
    describe("Triangle", () => {
        describe("Render Method", () => {
            test("renders triangle", () => {
                ...
                const renderString = `<polygon points="200,10 250,190, 160,210" fill="${testTriangle.shapeColor}"/>`;
